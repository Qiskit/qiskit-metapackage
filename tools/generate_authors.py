...
def main(repos=None, output_path=None):
    ...
    def generate_authors(git_dir, meta=False, whitelisted_authors=[]):
        ...
        co_authors_raw = _run_shell_command(co_author_cmd, git_dir)
        co_authors = re.findall("Co-authored-by:.+", co_authors_raw, re.MULTILINE | re.I)
        ...
        for author_str in co_authors:
            ...
            mailmap_out = _run_shell_command(["git", "check-mailmap", mailmap_contact], git_dir)
