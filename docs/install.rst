...
If the packages are installed correctly, you can run ``conda list`` to see the active
...
It is worth pointing that if you're a zsh user (which is the default shell on newer
